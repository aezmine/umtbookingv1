...
<body class="bg-gradient-to-r from-blue-500 to-indigo-700 flex flex-col items-center justify-center min-h-screen text-gray-800 p-4">
    ...
    <div class="bg-white shadow-2xl rounded-xl p-8 w-full max-w-5xl transform transition-all duration-300 hover:scale-[1.005]">
        ...
        <h2 class="text-3xl md:text-4xl font-extrabold text-center text-blue-700 mb-8 tracking-wide">All Bookings (Admin)</h2>
                            ...
                            <c:forEach var="b" items="${bookingList}">
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="BookingServlet?action=editForm&booking_id=${b.booking_id}"
                                           class="text-indigo-600 hover:text-indigo-900 transition-colors">
                                           <svg class="w-5 h-5 inline-block -mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                            Edit
                                        </a>
                                    </td>
                                </tr>
