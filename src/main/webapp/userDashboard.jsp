...
<body class="bg-gradient-to-r from-purple-500 to-pink-600 flex flex-col items-center justify-center min-h-screen text-gray-800 p-4">
    ...
    <div class="bg-white shadow-2xl rounded-xl p-8 w-full max-w-md transform transition-all duration-300 hover:scale-[1.01]">
        ...
        <h2 class="text-3xl md:text-4xl font-extrabold text-center text-purple-700 mb-4 tracking-wide">User Dashboard</h2>
        <p class="text-xl text-center text-gray-700 mb-8">Welcome, <strong class="text-purple-800"><%= user.getName() %></strong>!</p>

        <div class="p-6 bg-gray-50 rounded-lg shadow-md border border-gray-200">
            <h3 class="text-2xl font-bold text-gray-800 mb-4 border-b pb-2">Booking Actions</h3>
            <ul class="space-y-4">
                <li>
                    <a href="BookingServlet?action=showCreateForm"
                       class="flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-all duration-300 shadow-md">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        Book a Classroom
                    </a>
                </li>
                <li>
                    <a href="BookingServlet?action=listUser&user_id=<%= user.getUser_id() %>"
                       class="flex items-center justify-center px-6 py-3 bg-green-600 text-white font-semibold rounded-full hover:bg-green-700 transition-all duration-300 shadow-md">
